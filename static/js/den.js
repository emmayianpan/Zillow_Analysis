...
function makeMap() {
    ...
    d3.csv("../static/data/City/Denver.csv").then(function (response) {
...
function makeBar() {
    ...
    d3.csv("../static/data/Neighbourhood/Denver_Neighbourhood.csv").then(function (cityData) {
...
d3.csv("../static/data/Top5_Neighbourhood/Denver_Top5.csv").then(function (boxData) {
    console.log(boxData);
    ...
    var trace1 = {
      ...
      Plotly.newPlot("boxplot-den", data, layout);
}); 
}
