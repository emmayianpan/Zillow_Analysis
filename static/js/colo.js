...
function makeMap() {
    ...
    d3.csv("../static/data/City/Columbus.csv").then(function (response) {
...
function makeBar() {
    ...
    d3.csv("../static/data/Neighbourhood/Columbus_Neighbourhood.csv").then(function (cityData) {
...
d3.csv("../static/data/Top5_Neighbourhood/Columbus_Top5.csv").then(function (boxData) {
    console.log(boxData);
    ...
    var trace1 = {
      ...
      Plotly.newPlot("boxplot-colo", data, layout);
}); 
}
