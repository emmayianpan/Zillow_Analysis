...
function makeMap() {
    ...
    d3.csv("../static/data/City/Boston.csv").then(function (response) {
...
function makeBar() {
    ...
    d3.csv("../static/data/Neighbourhood/Boston_Neighbourhood.csv").then(function (cityData) {
...
d3.csv("../static/data/Top5_Neighbourhood/Boston_Top5.csv").then(function (boxData) {
    console.log(boxData);
    ...
    var trace1 = {
      ...
      Plotly.newPlot("boxplot-bos", data, layout);
}); 
}
