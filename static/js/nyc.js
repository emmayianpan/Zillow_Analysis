...
function makeMap() {
    ...
    d3.csv("../static/data/City/New_York_City.csv").then(function (response) {
...
function makeBar() {
    ...
    d3.csv("../static/data/Neighbourhood/New_York_City_Neighbourhood.csv").then(function (cityData) {
...
d3.csv("../static/data/Top5_Neighbourhood/New_York_City_Top5.csv").then(function (boxData) {
    console.log(boxData);
    ...
    var trace1 = {
      ...
      Plotly.newPlot("boxplot-nyc", data, layout);
}); 
}
