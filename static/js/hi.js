...
function makeMap() {
    ...
    d3.csv("../static/data/City/Hawaii.csv").then(function (response) {
...
function makeBar() {
    ...
    d3.csv("../static/data/Neighbourhood/Hawaii_Neighbourhood.csv").then(function (cityData) {
...
d3.csv("../static/data/Top5_Neighbourhood/Hawaii_Top5.csv").then(function (boxData) {
    console.log(boxData);
    ...
    var trace1 = {
      ...
      Plotly.newPlot("boxplot-hi", data, layout);
}); 
}
